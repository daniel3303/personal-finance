...
class ExpenseData extends TransactionData {
    ...
    public function createOrUpdateEntity(): Expense{
        if($this->entity === null){
            $this->entity = new Expense($this->getUser(), $this->getTitle(), $this->getTotal(), $this->getTime(), $this->getAccount(), $this->getTaxPayer(), $this->getCategory());
        }
